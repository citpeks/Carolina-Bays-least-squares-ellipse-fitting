...
def read_coordinates():
    ...
    for j in list1:
      # print("latitude ", j)
      ellipse_y.append( (float(j) - float(minlat))*111111 ) # Subtract latitude from minlat and convert to meters
...
#    X1, Y1 = make_test_ellipse()
    ...
    # [to do] For incomplete ellipse data points, we need to adjust center to get correct coordinates
